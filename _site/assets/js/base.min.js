...
(function(t) {
    ...
    function n(t) {
        function n(t) {
            if ("string" == typeof t && (t = document.querySelector(t)), t && "object" == typeof t && t.nodeType) {
                ...
                var L = e(n.height);
                return L !== !1 && (o.height = L + (_ ? 0 : m + w)), o.innerWidth = o.width - (g + b), 
                o.innerHeight = o.height - (m + w), o.outerWidth = o.width + v, o.outerHeight = o.height + x, 
                o;
            }
        }
        function a(t, e) {
    ...
    function o(t, o, r) {
        ...
        var h = r("transition"), p = r("transform"), u = h && p, c = !!r("perspective"), f = {
    ...
    function s(i, s, c, d, l, y) {
        function g(t, i) {
            if ("string" == typeof t && (t = a.querySelector(t)), !t || !f(t)) return h && h.error("Bad " + this.constructor.namespace + " element: " + t), 
            void 0;
        ...
        var v = 0, x = {};
        return g.namespace = "outlayer", g.Item = y, g.prototype.options = {
            containerStyle: {
                position: "relative"
            },
            isInitLayout: !0,
            ...
            n ? ("string" == typeof n ? i = this.element.querySelector(n) : f(n) && (i = n), 
            ...
            n.prototype.constructor = n, m(n, "options"), e(n.prototype.options, i), n.namespace = t, 
            n.data = g.data, n.Item = function() {
    ...
    var a = t.document, h = t.console, p = t.jQuery, u = function() {}, c = Object.prototype.toString, f = "object" == typeof HTMLElement ? function(t) {
    ...
    function e(t, e, i, n, o, r) {
        ...
        return h.Item = r, h.prototype._create = function() {
            ...
            if (o || r) {
                var s = this.columnWidth + this.gutter, a = this.rowHeight + this.gutter;
            ...
            if (n && (i = n.didDrag, n.dragStop()), !n || !i && !n.needsPositioning) return this.unstamp(e), 
            void 0;
